        ...
        <div class="col-md-6 col-md-offset-1">
            <div class="panel-box">
                    ...
                    <div class="form-group{{ $errors->has('name')?'has-error' : '' }}">
                        {!! Form::label('name', 'Nama', ['class'=>'col-md-12 ctrl-label']) !!}
                        <div class="col-md-6">
                    ...
                    <div class="form-group{{ $errors->has('clase_id') ? ' has-error' : '' }}">
                        {!! Form::label('clase_id', 'Kelas', ['class'=>'col-md-12 ctrl-label']) !!}
                        <div class="col-md-6">
                    ...
                    <div class="form-group{{ $errors->has('password_confirmation'?'has-error':'') }}">
                        {!! Form::label('password_confirmation', 'Konfirmasi Password', ['class'=>'col-md-12 ctrl-label']) !!}
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            <button type="submit" class="btn-main">
                                Daftar<i class="fa fa-chevron-right space"></i>
                            </button>
                        </div>
                    </div>
                    {!! Form::close() !!}
